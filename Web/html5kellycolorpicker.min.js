...
{x:a.x,y:a.y},this.sSide=this.path[2])};return a}function r(a,g,c,d){"object"!==typeof a&&(a=document.getElementById(a));if(!a)return!1;d||(d="");J[d+g]=c;a.addEventListener?a.addEventListener(g,J[d+g]):a.attachEvent("on"+g,J[d+g]);return!0}function n(a,g,c){"object"!==typeof a&&(a=document.getElementById(a));if(!a)return!1;c||(c="");if(!J[c+g])return!1;a.removeEventListener?a.removeEventListener(g,J[c+g]):a.detachEvent("on"+g,J[c+g]);J[c+g]=null;return!0}function N(a,g,c){var d,b,e,f,h,k;a&&void 0===
g&&void 0===c&&(g=a.s,c=a.v,a=a.h);f=Math.floor(6*a);h=6*a-f;a=c*(1-g);k=c*(1-h*g);g=c*(1-(1-h)*g);switch(f%6){case 0:d=c;b=g;e=a;break;case 1:d=k;b=c;e=a;break;case 2:d=a;b=c;e=g;break;case 3:d=a;b=k;e=c;break;case 4:d=g;b=a;e=c;break;case 5:d=c,b=a,e=k}return{r:Math.floor(255*d),g:Math.floor(255*b),b:Math.floor(255*e)}}function W(a){var b=function(a){a=a.toString(16);return 1===a.length?"0"+a:a};return"#"+b(a.r)+b(a.g)+b(a.b)}function aa(a,b){return{x:(a.x+b.x)/2,y:(a.y+b.y)/2}}function Z(a,b,c){b||
...
b.clearRect(0,0,q.width,q.height);if(H)return b.putImageData(Q,0,0),D&&p.draw(),!0;e.draw();x.draw();D&&p.draw();w||(Q=b.getImageData(0,0,u,u),H=!0);return!0}function L(){if(!ga())return!1;var a=360*k.h-e.startAngle;D&&(b.beginPath(),b.rect(p.pos.x-2,p.padding+p.height*(1-z)-1,p.width+4,2),b.strokeStyle="rgba(0,0,0, 0.8)",b.lineWidth=2,b.stroke(),b.closePath());b.beginPath();var g=v.path,c;c=I/180*a;for(var a=[],d=0;d<=g.length-1;++d)a[d]={x:g[d].x*Math.cos(c)-g[d].y*Math.sin(c),y:g[d].x*Math.sin(c)+
g[d].y*Math.cos(c)};for(g=0;g<=a.length-1;++g)a[g].x+=e.pos.x,a[g].y+=e.pos.y,0==g?b.moveTo(a[g].x,a[g].y):b.lineTo(a[g].x,a[g].y);b.strokeStyle="rgba(0,0,0,0.8)";b.lineWidth=v.lineWeight;b.stroke();b.closePath();b.strokeStyle=.5<k.v&&.5>k.s?"rgba(0, 0, 0, 1)":"rgba(255, 255, 255, 1)";b.beginPath();b.lineWidth=2;b.arc(k.x,k.y,ea.radius,0,2*I);b.stroke();b.closePath();return!1}var I=Math.PI,x,ea={radius:4},q=!1,b=!1,Y="quad",D=!1,w=!1,B=!0,J=[],h=[],C=document.createElement("canvas"),G=!1,H=!1,Q=null,
m=!1,ca=!0,S="mixed",l={tag:!1,margin:6},y=!1,f=this,ba,u=200,A,k,t,E="#000000",z=1,e={width:18,imageData:null};e.innerRadius;e.startAngle=0;e.outerRadius;e.outerStrokeStyle="rgba(0,0,0,0.2)";e.innerStrokeStyle="rgba(0,0,0,0.2)";e.pos;e.draw=function(){if(this.imageData)b.putImageData(this.imageData,0,0);else{for(var a=this.startAngle,g=0;360>=g;g++){var c=I/180*(g-2),d=I/180*g;b.beginPath();b.moveTo(A,A);b.arc(A,A,this.outerRadius,c,d,!1);b.closePath();c=N(a/360,1,1);b.fillStyle="rgb("+c.r+", "+
...
F.initStandartCursor())}};this.popUpClose=function(a){if(!1!==l.tag){if(a&&(a.target==m||a.target==q||a.target==l.tag))return!1;l.tag.style.display="none";KellyColorPicker.activePopUp==f&&(KellyColorPicker.activePopUp=!1)}};this.popUpShow=function(a){if(!1!==l.tag&&(!h.popupshow||(0,h.popupshow)(f,a))){KellyColorPicker.popupEventsInclude||(r(document,"click",function(a){return KellyColorPicker.activePopUp?KellyColorPicker.activePopUp.popUpClose(a):!1},"popup_close_"),r(window,"resize",function(a){if(KellyColorPicker.activePopUp)return KellyColorPicker.activePopUp.popUpShow(a)},
"popup_resize_"),KellyColorPicker.popupEventsInclude=!0);KellyColorPicker.activePopUp&&KellyColorPicker.activePopUp.popUpClose(!1);a=f.getCanvas().width;var b=f.getAlphaFig();b&&(a-=b.width+b.padding);b=parseInt(l.tag.style.paddingBottom)+parseInt(l.tag.style.paddingTop);0>=b&&(b=0);var c=m.getBoundingClientRect(),d=c.left+(window.scrollX||window.pageXOffset||document.body.scrollLeft);l.tag.style.top=c.top+(window.scrollY||window.pageYOffset||document.body.scrollTop)-b-a-l.margin+"px";l.tag.style.left=
d+"px";l.tag.style.display="block";KellyColorPicker.activePopUp=f;return!1}};this.setHueByDot=function(a){a=Z(a,e.pos)+e.startAngle;0>a&&(a=360+a);k.h=a/360;t=N(k.h,k.s,k.v);E=W(t);h.change&&(0,h.change)(f);P();H=!1;L()};this.setColorByHex=function(a,b){b||(b=!1);var c=z;if(!1!==a){if(!a||!a.length)return;var d=M(a,!0);if(!d)return;a=d.h;D&&(c=d.a)}else a=E;if(D&&a==E&&H&&c!=z)z=c,L();else if(!E||a!=E||!H){z=c;c=a;c=parseInt("#"==c.charAt(0)?c.slice(1):c,16);t={r:c>>16,g:c>>8&255,b:c&255};E=a;var c=
t,e=d=void 0;c&&void 0===d&&void 0===e&&(d=c.g,e=c.b,c=c.r);var c=c/255,d=d/255,e=e/255,l=Math.max(c,d,e),n=Math.min(c,d,e),m,p=l-n;if(l==n)m=0;else{switch(l){case c:m=(d-e)/p+(d<e?6:0);break;case d:m=(e-c)/p+2;break;case e:m=(c-d)/p+4}m/=6}k={h:m,s:0==l?0:p/l,v:l};m=x.svToDot(k);k.x=m.x;k.y=m.y;H=!1;L();h.change&&(0,h.change)(f);P(b)}};this.setAlphaByDot=function(a){z=p.dotToAlpha(a);h.change&&(0,h.change)(f);P();L()};this.setAlpha=function(a){z=a;P();L()};this.setColorByDot=function(a){var b=x.dotToSv(a);
k.s=b.s;k.v=b.v;k.x=a.x;k.y=a.y;1<k.s&&(k.s=1);0>k.s&&(k.s=0);1<k.v&&(k.v=1);0>k.v&&(k.v=0);t=N(k.h,k.s,k.v);E=W(t);h.change&&(0,h.change)(f);P();L()};this.mouseOutEvent=function(a){0<F.curType&&!KellyColorPicker.cursorLock&&F.initStandartCursor()};this.mouseMoveRest=function(a){if(!w&&B){B=!1;var b=K(a);F.updateCursor(b);requestAnimationFrame(function(){B=!0});h.mousemoverest&&(0,h.mousemoverest)(a,f,b)}};this.touchMoveEvent=function(a){w&&event.preventDefault()};this.mouseDownEvent=function(a){a.preventDefault();
...
"mouseup",c,"action_process_"),r(document,"mousemove",b,"action_process_"),r(document,"touchend",c,"action_process_"),r(document,"touchmove",b,"action_process_"))};this.wheelMouseMove=function(a,b){a.preventDefault();if(w&&B){B=!1;var c=K(a);requestAnimationFrame(function(){B=!0});f.setHueByDot(c);h.mousemoveh&&(0,h.mousemoveh)(a,f,c)}};this.wheelMouseUp=function(a,b){a.preventDefault();if(w){n(document,"mouseup","action_process_");n(document,"mousemove","action_process_");n(document,"touchend","action_process_");
n(document,"touchmove","action_process_");T();H=w=!1;L();var c=K(a);F.updateCursor(c);h.mouseuph&&(0,h.mouseuph)(a,f,c)}};this.alphaMouseMove=function(a,b){a.preventDefault();if(w&&B){B=!1;var c=K(a),c=p.limitDotPosition(c);requestAnimationFrame(function(){B=!0});f.setAlphaByDot(c);h.mousemovealpha&&(0,h.mousemovealpha)(a,f,c)}};this.alphaMouseUp=function(a,b){a.preventDefault();if(w){n(document,"mouseup","action_process_");n(document,"mousemove","action_process_");n(document,"touchend","action_process_");
n(document,"touchmove","action_process_");T();w=!1;var c=K(a);F.updateCursor(c);h.mouseupalpha&&(0,h.mouseupalpha)(a,f,c)}};this.svMouseMove=function(a,b){a.preventDefault();if(w&&B){B=!1;var c=K(a),c=x.limitDotPosition(c);requestAnimationFrame(function(){B=!0});f.setColorByDot(c);h.mousemovesv&&(0,h.mousemovesv)(a,f,c)}};this.svMouseUp=function(a,b){a.preventDefault();if(w){n(document,"mouseup","action_process_");n(document,"mousemove","action_process_");n(document,"touchend","action_process_");
n(document,"touchmove","action_process_");T();w=!1;var c=K(a);F.updateCursor(c);h.mouseupsv&&(0,h.mouseupsv)(a,f,c)}};this.addUserEvent=function(a,b){h[a]=b;return!0};this.removeUserEvent=function(a){if(!h[a])return!1;h[a]=null;return!0};this.getCanvas=function(){return b?q:!1};this.getCtx=function(){return b?b:!1};this.getInput=function(){return m};this.getSvFig=function(){return x};this.getSvFigCursor=function(){return ea};this.getWheel=function(){return e};this.getWheelCursor=function(){return v};
this.getCurColorHsv=function(){return k};this.getCurColorRgb=function(){return t};this.getCurColorHex=function(){return E};this.getCurColorRgba=function(){return{r:t.r,g:t.g,b:t.b,a:z}};this.getCurAlpha=function(){return z};this.getAlphaFig=function(){return D?p:!1};this.getPopup=function(){return l};this.getSize=function(){return u};this.updateView=function(a){if(!b)return!1;a&&(e.imageData=null,Q=x.imageData=null);H=!1;X();L();return!0};this.resize=function(a){if(!b)return!1;if(a==u)return!0;H=
!1;e.imageData=null;Q=x.imageData=null;u=a;X();f.setColorByHex(!1);return!1};this.destroy=function(){0<F.curType&&(KellyColorPicker.cursorLock=!1,F.initStandartCursor());w&&(n(document,"mouseup","action_process_"),n(document,"mousemove","action_process_"),n(document,"touchend","action_process_"),n(document,"touchmove","action_process_"),w=!1);l.tag&&n(m,"click","popup_");m&&(n(m,"click","input_edit_"),n(m,"change","input_edit_"),n(m,"keyup","input_edit_"),n(m,"keypress","input_edit_"));KellyColorPicker.popupEventsInclude&&
J.popup_close_click&&(KellyColorPicker.activePopUp&&KellyColorPicker.activePopUp.popUpClose(!1),n(document,"click","popup_close_"),n(window,"resize","popup_resize_"),KellyColorPicker.popupEventsInclude=!1);e.imageData=null;C=Q=x.imageData=null;y&&y.parentNode&&y.parentNode.removeChild(y);da();f=null};(function(a){var b="",c="";a.input&&"object"!==typeof a.input?(a.input=document.getElementById(a.input),m=a.input):"object"===typeof a.input&&(m=a.input);void 0!==a.alpha&&(z=a.alpha);void 0!==a.alpha_slider&&
(D=a.alpha_slider);void 0!==a.input_color&&(ca=a.input_color);void 0!==a.input_format&&(S=a.input_format);a.userEvents&&(h=a.userEvents);a.place&&"object"!==typeof a.place&&(c=a.place,a.place=document.getElementById(a.place));a.place?y=a.place:m?(l.tag=document.createElement("div"),l.tag.className="popup-kelly-color",a.popupClass?l.tag.className=a.inputClassName:(l.tag.className="popup-kelly-color",l.tag.style.position="absolute",l.tag.style.bottom="0px",l.tag.style.left="0px",l.tag.style.display=
"none",l.tag.style.backgroundColor="#e1e1e1",l.tag.style.border="1px solid #bfbfbf",l.tag.style.boxShadow="7px 7px 14px -3px rgba(0,0,0,0.24)",l.tag.style.borderTopLeftRadius="4px",l.tag.style.borderTopRightRadius="4px",l.tag.style.borderBottomLeftRadius="4px",l.tag.style.borderBottomRightRadius="4px",l.tag.style.padding="12px"),y=l.tag,document.getElementsByTagName("body")[0].appendChild(l.tag),r(m,"click",function(a){return f.popUpShow(a)},"popup_")):b+='| "place" ('+c+") not not found";a.size&&
0<a.size&&(u=a.size);a.color?E=a.color:m&&m.value&&(c=M(m.value),E=c.h,D&&(z=c.a));!a.method||"triangle"!=a.method&&"quad"!=a.method||(Y=a.method);fa()||(b+=" | cant init canvas context");b?"undefined"!==typeof console&&console.log("KellyColorPicker : "+b):("quad"==Y&&(x=R()),"triangle"==Y&&(x=O()),m&&(a=function(a){a=a||window.event;a.target||(a.target=a.srcElement);f.setColorByHex(a.target.value,!0)},r(m,"click",a,"input_edit_"),r(m,"change",a,"input_edit_"),r(m,"keyup",a,"input_edit_"),r(m,"keypress",
